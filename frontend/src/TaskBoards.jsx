...
const TaskBoards = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const response = await axios.get('https://to-do-interview-buddy-bo1h.vercel.app/api/projects');
  ...
  const handleAddProject = async () => {
    if (newProjectName) {
      try {
        const response = await axios.post('https://to-do-interview-buddy-bo1h.vercel.app/api/projects', { name: newProjectName });
  ...
  const handleAddTask = async (task, projectIndex) => {
    try {
      ...
      await axios.post(`https://to-do-interview-buddy-bo1h.vercel.app/api/projects/${projectId}/tasks`, task);
  ...
  const handleEditTask = async (updatedTask, projectIndex) => {
    ...
    try {
      await axios.put(`https://to-do-interview-buddy-bo1h.vercel.app/api/projects/${projectId}/tasks/${taskId}`, updatedTask);
      const updatedProjects = [...projects];
  ...
  const handleDeleteTask = async (taskId, projectIndex) => {
    ...
    try {
      await axios.delete(`https://to-do-interview-buddy-bo1h.vercel.app/api/projects/${projectId}/tasks/${taskId}`);
      const updatedProjects = [...projects];
